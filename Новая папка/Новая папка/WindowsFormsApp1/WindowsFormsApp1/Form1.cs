...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            calculatingForm.Controls.Add(rb);
            calculatingForm.Controls.Add(rb1);
            calculatingForm.Controls.Add(rb2);
        }


        private void RadioButton_CheckedChanged(object sender, EventArgs e)
        {
            mult = Int32.Parse((sender as RadioButton).Text);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            calculatingForm.Controls["textBox1"].Text = this.Controls["textBox2"].Text;
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            this.Controls["textBox2"].Text = calculatingForm.Controls["textBox1"].Text;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int index = 0, index2 = 0, lenght = str.Length; index < lenght; ++index)
            {
                ...
                if (Char.Equals(str[index],' ') || index + 1 == lenght)
                {
                    ...
                    {
                        tmp.Append((Int32.Parse(tmp1.ToString()) * mult).ToString() + " ");
                        index2++;
                        tmp1.Clear();
                    }
                }
